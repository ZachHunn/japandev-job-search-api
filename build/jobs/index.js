...
import { createJob, createManyJobs, deleteManyJobs, jobsFromXata, } from "../repository/xataDatabaseRepo";
...
app.delete("/api/jobs/delete", async (req, res) => {
    ...
    const jobsRemovedFromJapanDev = getJobsRemovedFromJapanDev(await jobsFromXata, jobIdsFromJapanDev);
